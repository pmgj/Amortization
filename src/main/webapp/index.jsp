                    ...
                    <p>
                        ...
                        <select name="option" id="option">
                            <c:forEach var="system" items="${systems}" varStatus="status">
                                <option value="${status.index}" ${param.option eq status.index ? 'selected="selected"'
                                    : "" }>${system}</option>
                            </c:forEach>
                        </select>
                    </p>
                    <p><label for="principal">Principal:</label> <input type="number" name="principal" id="principal"
                            value="${param.principal}" min="0" /></p>
                    <p><label for="period">Period in months:</label> <input type="number" name="period" id="period"
                            value="${param.period}" min="0" /></p>
                    <p><label for="rate">Monthly interest rate:</label> <input type="number" name="rate" id="rate"
                            value="${param.rate}" min="0" /></p>
